...
class Review(models.Model):
    ...
    reviewer = models.ForeignKey(TimeBankUser, on_delete=models.CASCADE, related_name='given_reviews')
    reviewed_user = models.ForeignKey(TimeBankUser, on_delete=models.CASCADE, related_name='received_reviews')
