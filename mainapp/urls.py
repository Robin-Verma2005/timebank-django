...
from .views import complete_request
...
path('complete-request/<int:request_id>/', complete_request, name='complete_request'),
path('review/<int:request_id>/', views.give_review, name='give_review'),
